...
def guardar_equipos(TM : teammaker.TeamMaker, nombre_agrupamiento, id_modelo, ids_alumnos, tipo_agrupamiento, ids_caracteristicas):
        try:
                ...
                Agrupamiento.tipo = tipo_agrupamiento
